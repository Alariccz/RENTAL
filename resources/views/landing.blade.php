<x-front-layout>
  <!-- Hero -->
  <section class="container relative pb-[100px] pt-[30px]" id="hero">
    ...
    <div class="container relative py-[100px]">
      <header class="mb-[30px]">
        <div class="flex items-center justify-between mb-1">
          <h2 class="font-bold text-dark text-[26px]">
            Popular Cars
          </h2>
          <a href="/catalog" class="text-sm text-blue-500 hover:underline">
            See All
          </a>
        </div>
