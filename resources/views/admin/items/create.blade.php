          ...
          <form class="w-full" action="{{ route('admin.items.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <select name="brand_id" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200
                 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500" required>
                ...
                <div class="mt-2 text-sm text-gray-500">
                  Brand items. Contoh: Porsche, Ford, Mercedes, Wajib diisi.
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <select name="type_id" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200
                 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500" required>
                ...
                <div class="mt-2 text-sm text-gray-500">
                  Type items. Contoh: Electric Car, Wajib diisi.
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <div class="mt-2 text-sm text-gray-500">
                  Nama fitur. Contoh: Fitur 1, Fitur 2, Fitur 3, dsb. Dipisahkan dengan koma (,). Opsional
                </div>
              </div>
            </div>
